...
export async function GET(req, { params }) {
  try {
    ...
    // ============================
    // Dates: Today & Yesterday (business timezone)
    // ============================
    ...
    // ============================
    // Last 20 days sales (fixed)
    // ============================
    const days = 20;
    const startDateLocal = new Date(todayStartLocal);
    startDateLocal.setDate(startDateLocal.getDate() - (days - 1));
    const startDateUTC = toUTC(startDateLocal);
